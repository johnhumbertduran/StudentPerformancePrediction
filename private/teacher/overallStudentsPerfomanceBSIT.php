...
$prelim_qry = mysqli_query($connections, "SELECT * FROM prelim1 WHERE course='BSIT' ");
$midterm_qry = mysqli_query($connections, "SELECT * FROM midterm1 WHERE course='BSIT' ");
$prefinal_qry = mysqli_query($connections, "SELECT * FROM prefinal1 WHERE course='BSIT' ");
$final_qry = mysqli_query($connections, "SELECT * FROM final1 WHERE course='BSIT' ");
